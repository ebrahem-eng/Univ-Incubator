                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><button
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{route('ladmin.university.college.index' , $university->id)}}">College</a>
                                                                    ...
                                                                    <a class="dropdown-item" href="{{route('ladmin.university.edit.address' , $university->id)}}">Edit Address</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    @endforeach
