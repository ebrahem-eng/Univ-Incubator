...
<head>
    ...
    <title>University College Specializations Table</title>
    <!-- Simple bar CSS -->
        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">University College Specializations Table </h2>
                                ...
                                <div class="card shadow">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <a style="color: white"
                                                href="{{ route('ladmin.university.college.specialization.choose', $universityCollege) }}"
                                                class="btn btn-primary">Choose New Specialization</a>
                                            <br>
                                            <br>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="row">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('ladmin.university.college.specialization.revoke', $specialization->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
