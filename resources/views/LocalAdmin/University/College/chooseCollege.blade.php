...
<head>
    ...
    <title>Choose College University</title>
    <!-- Simple bar CSS -->
        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">College Table </h2>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($colleges as $college)
                                                        <tr>
                                                            ...
                                                            <td>{{ $college->ladmin->name }}</td>
                                                            <td>{{ $college->created_at }}</td>
                                                            <td>{{ $college->updated_at }}</td>
                                                            <td>
                                                                <form action="{{route('ladmin.university.store.choose.college' , $college->id)}}" method="POST">
                                                                    @csrf
