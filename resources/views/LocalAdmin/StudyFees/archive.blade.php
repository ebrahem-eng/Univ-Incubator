...
<head>
    ...
    <title>Study Fees Archive Table</title>
    <!-- Simple bar CSS -->
        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">StudyFees Archive Table </h2>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table datatables" id="dataTable-1">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($studyFeeses as $studyFees)
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>{{ $studyFees->id }}</td>
                                                            <td>{{ $studyFees->annualFees }}</td>
                                                            <td>{{ $studyFees->annualFeesNumber }}</td>
                                                            <td>{{ $studyFees->details }}</td>
                                                            <td>{{ $studyFees->annualFeesDate }}</td>
                                        
                                                        
                                                            <td>{{ $studyFees->univCollege->university->name }}</td>

                                                            <td>{{ $studyFees->univCollege->college->name }}</td>

                                                            <td>{{ $studyFees->created_at }}</td>
                                                            <td>{{ $studyFees->updated_at }}</td>
                                                            <td>{{ $studyFees->deleted_at }}</td>
                                                            <td><button
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('ladmin.studyFees.restore', $studyFees->id) }}">Restore</a>


                                                                    <form
                                                                        action="{{ route('ladmin.studyFees.force.delete', $studyFees->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
