        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">StudyFees Table </h2>
                                                            ...
                                                            <td><button
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('ladmin.studyFees.edit', $studyFees->id) }}">Edit</a>


                                                                    <form
                                                                        action="{{ route('ladmin.studyFees.soft.delete', $studyFees->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
