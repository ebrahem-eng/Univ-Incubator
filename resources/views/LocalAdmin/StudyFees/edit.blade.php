            ...
            <div class="card-deck">
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <strong class="card-title">Update StudyFees</strong>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('ladmin.studyFees.update' , $studyFees->id ) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="form-row">
                                <div class="form-group col-md-5">
                                    ...
                                    <input type="text" class="form-control" id="inputEmail4" placeholder="Annula Fees"
                                        name="annualFees" value="{{$studyFees->annualFees}}" required>
                                </div>
                                    ...
                                    <div class="form-group col-md-5">
                                        ...
                                        <input type="number" class="form-control" id="inputEmail4" placeholder="Annual Fees Number"
                                            name="annualFeesNumber" value="{{$studyFees->annualFeesNumber}}" required>
                                    </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="date" class="form-control" name="annualFeesDate" id="dateEvent" value="{{$studyFees->annualFeesDate}}" required="">
                                    <p id="dayName"></p>
                                </div>

                                <div class="form-group col-md-5">
                                    <label for="inputEmail4">Details</label>
                                    <input type="text" class="form-control" id="inputEmail4" value="{{$studyFees->details}}" placeholder=". . . . ."
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-5">
                                    ...
                                    <select id="inputState" class="form-control" name="univercityCollegeID">
                                        ...
                                        <option value="{{$universityCollege->id}}" {{ $studyFees->univercityCollegeID == $universityCollege->id ? 'selected' : '' }}>{{$universityCollege->university->name}} / {{$universityCollege->college->name}}</option>
                                        @endforeach
