...
<head>
    ...
    <title>Add University College</title>
    <!-- Simple bar CSS -->
            ...
            <div class="card-deck">
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <strong class="card-title">Add University College</strong>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('ladmin.college.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
