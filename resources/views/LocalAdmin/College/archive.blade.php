...
<head>
    ...
    <title>University College Archive Table</title>
    <!-- Simple bar CSS -->
        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">University College Archive Table </h2>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($universityColleges as $universityCollege)
                                                        <tr>
                                                            ...
                                                            <td>{{ $universityCollege->deleted_at }}</td>
                                                            <td><button
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a class="dropdown-item"
                                                                    href="{{ route('ladmin.college.restore', $universityCollege->id) }}">Restore</a>
                                                                <form
                                                                    action="{{ route('ladmin.college.force.delete', $universityCollege->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('delete')
