        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">Event Image Table </h2>
                                ...
                                <div class="card shadow">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <a style="color: white"
                                            href="{{ route('ladmin.college.event.university.college.events.image.create', $collegeEventID) }}"
                                            ...
                                            <table class="table datatables" id="dataTable-1">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($collegeEventImages as $collegeEventImage)
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>{{ $collegeEventImage->id }}</td>
                                                 
                                                            <td>
                                                                <img src="{{ asset('Image/' . $collegeEventImage->img) }}"
                                                                    style="width: 100px; height: 100px;">
                                                            </td>

                                                            <td>{{ $collegeEventImage->details }}</td>
                                                            <td>{{ $collegeEventImage->created_at }}</td>
                                                            ...
                                                            <td><button
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('ladmin.college.event.university.college.events.image.delete', $collegeEventImage->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
