...
<head>
    ...
    <title>University Event Image Table</title>
    <!-- Simple bar CSS -->
        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">University Event Image Table </h2>
                                ...
                                <div class="card shadow">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <a style="color: white"
                                            href="{{ route('ladmin.university.event.image.create', $univEventId) }}"
                                            ...
                                            <table class="table datatables" id="dataTable-1">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($universityEventImages as $universityEventImage)
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>{{ $universityEventImage->id }}</td>
                                                 
                                                            <td>
                                                                <img src="{{ asset('Image/' . $universityEventImage->img) }}"
                                                                    style="width: 100px; height: 100px;">
                                                            </td>

                                                            <td>{{ $universityEventImage->details }}</td>
                                                            <td>{{ $universityEventImage->created_at }}</td>
                                                            ...
                                                            <td><button
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('ladmin.university.event.image.delete', $universityEventImage->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
