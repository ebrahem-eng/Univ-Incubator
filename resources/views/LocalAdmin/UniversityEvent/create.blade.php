...
<head>
    ...
    <title>Create University Event</title>
    <!-- Simple bar CSS -->
        ...
        <main role="main" class="main-content">
            ...
            <div class="card-deck">
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <strong class="card-title">Add University Event</strong>
                    </div>
            ...
            @endif
                ...
                {{-- end  message Section --}}
                    ...
                    <div class="card-body">
                        <form action="{{ route('ladmin.university.event.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    @foreach ($universities as $university)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="universityIDs[]" value="{{ $university->id }}" id="university{{ $university->id }}">
