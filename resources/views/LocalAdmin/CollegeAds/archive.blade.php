...
<head>
    ...
    <title>College Ads Archive Table</title>
    <!-- Simple bar CSS -->
        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">College Ads Archive Table </h2>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table datatables" id="dataTable-1">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($collegeAdss as $collegeAds)
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>{{ $collegeAds->id }}</td>
                                                            <td>{{ $collegeAds->name }}</td>
                                                            <td>{{ $collegeAds->title }}</td>
                                                            <td>{{ $collegeAds->body }}</td>                                                   
                                                            <td>{{ $collegeAds->details }}</td>
                                                            <td>
                                                                <img src="{{ asset('Image/' . $collegeAds->img) }}"
                                                                    style="width: 100px; height: 100px;">
                                                            </td>

                                                            <td>{{ $collegeAds->univCollege->university->name }}</td>

                                                            <td>{{ $collegeAds->univCollege->collegeName }}</td>

                                                          

                                                            <td>{{ $collegeAds->LAdmin->name }}</td>
                                                            <td>{{ $collegeAds->created_at }}</td>
                                                            <td>{{ $collegeAds->updated_at }}</td>
                                                            <td>{{ $collegeAds->deleted_at }}</td>
                                                            <td><button
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('ladmin.college.ads.restore', $collegeAds->id) }}">Restore</a>
                                                                    <form
                                                                        action="{{ route('ladmin.college.ads.force.delete', $collegeAds->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
