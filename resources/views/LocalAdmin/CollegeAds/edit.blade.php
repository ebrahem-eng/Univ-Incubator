        ...
        <main role="main" class="main-content">
            ...
            <div class="card-deck">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('ladmin.college.ads.update' , $collegeAds->id) }}" method="POST"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="inputEmail4" placeholder="Name"
                                        name="name" value="{{$collegeAds->name}}" required>
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="inputEmail4">Title</label>
                                    <input type="text" class="form-control" id="inputEmail4" name="title" value="{{$collegeAds->title}}" required>
                                </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" class="form-control" id="inputPassword4" placeholder=""
                                        name="body" value="{{$collegeAds->body}}" required>
                                </div>

                                <div class="form-group col-md-4">
                                    <label for="inputEmail4">Details</label>
                                    <input type="text" class="form-control" id="inputEmail4" name="details" value="{{$collegeAds->details}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-5">
                                    ...
                                    <select id="inputState" class="form-control" name="univCollegeID">
                                        ...
                                        <option value="{{$universityCollege->id}}" {{ $collegeAds->univCollegeID == $universityCollege->id ? 'selected' : '' }}>{{$universityCollege->university->name}} / {{$universityCollege->collegeName}}</option>
                                        @endforeach
                                    </select>
                                </div>
