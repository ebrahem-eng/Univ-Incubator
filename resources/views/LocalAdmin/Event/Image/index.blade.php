                                ...
                                <div class="card shadow">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <a style="color: white"
                                            href="{{ route('ladmin.event.image.create', $eventID) }}"
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($eventImages as $eventImage)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img src="{{ asset('Image/' . $eventImage->img) }}"
                                                                    style="width: 100px; height: 100px;">
                                                            </td>

                                                            <td>{{ $eventImage->details }}</td>
                                                            <td>{{ $eventImage->created_at }}</td>
                                                            ...
                                                            <td><button
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('ladmin.event.image.delete', $eventImage->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
