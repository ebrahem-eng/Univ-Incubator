                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-5">
                                    ...
                                    <select id="inputState" class="form-control" name="univercityCollegeID">
                                        ...
                                        <option value="{{$universityCollege->id}}" {{ $event->univercityCollegeID == $universityCollege->id ? 'selected' : '' }}>{{$universityCollege->university->name}} / {{$universityCollege->college->name}}</option>
                                        @endforeach
