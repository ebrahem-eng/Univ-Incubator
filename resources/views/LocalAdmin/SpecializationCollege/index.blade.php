...
<head>
    ...
    <title>Specialization College Table</title>
    <!-- Simple bar CSS -->
        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">Specialization College Table </h2>
                                                            ...
                                                            <td><button
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('ladmin.specialization.college.edit', $specializationCollege->id) }}">Edit</a>
                                                                    <form
                                                                        action="{{ route('ladmin.specialization.college.soft.delete', $specializationCollege->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
