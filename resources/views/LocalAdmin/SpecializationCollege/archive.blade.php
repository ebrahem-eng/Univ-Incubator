...
<head>
    ...
    <title>Specialization College Archive Table</title>
    <!-- Simple bar CSS -->
        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">Specialization College Archive Table </h2>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($specializationColleges as $specializationCollege)
                                                        <tr>
                                                            ...
                                                            <td>{{ $specializationCollege->id }}</td>
                                                            <td>{{ $specializationCollege->name }}</td>

                                                            <td>
                                                                <img src="{{ asset('Image/' . $specializationCollege->img) }}"
                                                                    style="width: 100px; height: 100px;">
                                                            </td>

                                                            <td>{{ $specializationCollege->univCollege->university->name }}
                                                            </td>

                                                            <td>{{ $specializationCollege->univCollege->collegeName }}
                                                            </td>



                                                            <td>{{ $specializationCollege->LAdmin->name }}</td>
                                                            <td>{{ $specializationCollege->created_at }}</td>
                                                            <td>{{ $specializationCollege->updated_at }}</td>
                                                            <td>{{ $specializationCollege->deleted_at }}</td>
                                                            <td><button
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('ladmin.specialization.college.restore', $specializationCollege->id) }}">Restore</a>
                                                                    <form
                                                                        action="{{ route('ladmin.specialization.college.force.delete', $specializationCollege->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
