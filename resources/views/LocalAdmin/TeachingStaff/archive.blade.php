...
<head>
    ...
    <title>Teaching Staff Archive Table</title>
    <!-- Simple bar CSS -->
        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">Teaching Staff Archive Table </h2>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($teachingStaffs as $teachingStaff)
                                                        <tr>
                                                            ...
                                                            <td>{{ $teachingStaff->deleted_at }}</td>
                                                            <td><button
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('ladmin.teachingStaff.restore', $teachingStaff->id) }}">Restore</a>
                                                                    <form
                                                                        action="{{ route('ladmin.teachingStaff.force.delete', $teachingStaff->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
