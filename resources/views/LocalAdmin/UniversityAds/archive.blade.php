...
<head>
    ...
    <title>University Ads Archive Table</title>
    <!-- Simple bar CSS -->
        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">University Ads Archive Table </h2>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table datatables" id="dataTable-1">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($universityAdss as $universityAds)
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>{{ $universityAds->id }}</td>
                                                            <td>{{ $universityAds->name }}</td>
                                                            <td>{{ $universityAds->title }}</td>
                                                            <td>{{ $universityAds->body }}</td>                                                   
                                                            <td>{{ $universityAds->details }}</td>
                                                            <td>
                                                                <img src="{{ asset('Image/' . $universityAds->img) }}"
                                                                    style="width: 100px; height: 100px;">
                                                            </td>

                                                            <td>{{ $universityAds->university->name }}</td>

                                                            <td>{{ $universityAds->LAdmin->name }}</td>
                                                            <td>{{ $universityAds->created_at }}</td>
                                                            <td>{{ $universityAds->updated_at }}</td>
                                                            <td>{{ $universityAds->deleted_at }}</td>
                                                            <td><button
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('ladmin.university.ads.restore', $universityAds->id) }}">Restore</a>
                                                                    <form
                                                                        action="{{ route('ladmin.university.ads.force.delete', $universityAds->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
