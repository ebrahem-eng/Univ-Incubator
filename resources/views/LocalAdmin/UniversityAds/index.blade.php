...
<head>
    ...
    <title>University Ads Table</title>
    <!-- Simple bar CSS -->
        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">University Ads Table </h2>
                                                            ...
                                                            <td><button
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('ladmin.university.ads.edit', $universityAds->id) }}">Edit</a>
                                                                    <form
                                                                        action="{{ route('ladmin.university.ads.soft.delete', $universityAds->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
