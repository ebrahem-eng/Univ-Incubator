...
<head>
    ...
    <title>Choose College University Ads Table</title>
    <!-- Simple bar CSS -->
        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">Choose College University Ads Table </h2>
                                ...
                                <div class="card shadow">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            {{-- <a style="color: white"
                                                href="{{ route('ladmin.ads.choose.college.university', $universityAdsID) }}"
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($colleges as $college)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <form
                                                                    action="{{ route('ladmin.ads.store.choose.college.university', $college->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <button class="btn btn-success">
                                                                        Choose
                                                                    </button>
                                                                    <input type="hidden" value="{{ $universityAdsID }}"
                                                                        name="universityAdsID">
                                                                </form>
