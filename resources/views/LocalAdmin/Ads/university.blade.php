                                ...
                                <div class="card shadow">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <a style="color: white"
                                            href="{{ route('ladmin.ads.choose.university', $adsID) }}"
                                            class="btn btn-primary">Choose New University</a>
<br>
<br>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><button
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    ...
                                                                    <form action="{{route('ladmin.ads.college.university' , $university->id)}}" method="get">
                                                                        @csrf
                                                                        <button class="dropdown-item" type="submit">College</button>
                                                                        <input name="adsID" type="hidden" value="{{$adsID}}">
                                                                    </form>

                                                                    <form action="{{route('ladmin.ads.university.revoke' , $university->id)}}" method="POST">
                                                                        @csrf
                                                                        @method('delete')
                                                                        <button class="dropdown-item" type="submit">Revoke</button>
