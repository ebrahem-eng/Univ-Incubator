        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">Ads Table </h2>
                                                            ...
                                                            <td><button
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('ladmin.ads.edit', $ads->id) }}">Edit</a>
                                                                    <form
                                                                        action="{{ route('ladmin.ads.soft.delete', $ads->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('ladmin.ads.university', $ads->id) }}">
                                                                        University & College
                                                                        </a>
                                                                </div>
                                                            </td>
