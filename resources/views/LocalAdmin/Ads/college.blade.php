...
<head>
    ...
    <title>College University Ads Table</title>
    <!-- Simple bar CSS -->
        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">College University Ads Table </h2>
                                ...
                                <div class="card shadow">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <form action="{{ route('ladmin.ads.choose.college.university', $universityAdsID) }}" method="GET">
                                                @csrf
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($colleges as $college)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <form
                                                                    action="{{ route('ladmin.ads.college.university.revoke', $college->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('delete')
