...
<head>
    ...
    <title>Choose University Ads Table</title>
    <!-- Simple bar CSS -->
        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">Choose University Ads Table </h2>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($universities as $university)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <form action="{{route('ladmin.ads.store.choose.university' , $university->id)}}" method="POST">
                                                                    @csrf
                                                                    <button class="btn btn-success">
                                                                        Choose
                                                                    </button>
                                                                    <input type="hidden" value="{{$adsID}}" name="adsID" >
                                                                </form>
