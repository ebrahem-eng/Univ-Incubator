        ...
        <main role="main" class="main-content">
            ...
            <div class="card-deck">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('ladmin.ads.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-7">
                                    ...
                                    <input type="text" class="form-control" id="inputCity" name="body" required>
                                </div>

                                <div class="form-group col-md-5">
                                    <label for="inputCity">Details</label>
                                    <input type="text" class="form-control" id="inputCity" name="details" required>
                                </div>
