        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">Ads Archive Table </h2>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($ads as $ads)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img src="{{ asset('Image/' . $ads->img) }}"
                                                                    style="width: 100px; height: 100px;">
                                                            </td>

                                                            <td>{{ $ads->ladmin->name }}</td>
                                                            ...
                                                            <td><button
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('ladmin.ads.restore', $ads->id) }}">Restore</a>
                                                                    <form
                                                                        action="{{ route('ladmin.ads.force.delete', $ads->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
