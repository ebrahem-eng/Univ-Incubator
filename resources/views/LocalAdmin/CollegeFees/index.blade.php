...
<head>
    ...
    <title>College Fees Table</title>
    <!-- Simple bar CSS -->
        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">College Fees Table </h2>
                                                            ...
                                                            <td><button
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('ladmin.college.fees.edit', $collegeFees->id) }}">Edit</a>


                                                                    <form
                                                                        action="{{ route('ladmin.college.fees.soft.delete', $collegeFees->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
