...
<head>
    ...
    <title>Local Admin Archive</title>
    <!-- Simple bar CSS -->
        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">Local Admin Archive </h2>
                                                            ...
                                                            <td><button
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('gadmin.ladmin.restore', $lAdmin->id) }}">Restore</a>
                                                                    <form
                                                                        action="{{ route('gadmin.ladmin.force.delete', $lAdmin->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
