...
<head>
    ...
    <title>Specialization Table</title>
    <!-- Simple bar CSS -->
        ...
        <main role="main" class="main-content">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">Specialization Table </h2>
                                                            ...
                                                            <td><button
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('gadmin.specialization.restore', $specialization->id) }}">Restore</a>
                                                                    <form
                                                                        action="{{ route('gadmin.specialization.force.delete', $specialization->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
